...
// Factors
const RESULT_BASE = 1.91718;
const GENDER_MALE_COEF = -0.19040472041079;
const HYDRONEPHROSIS_COEF = -0.206111005211143;
const HYDROURETER_COEF = 0.237600162441429;
const TEMPERATURE_COEF = 0.31387545388584;
const NEUTROPHILS_COEF = 0.0278064357876215;

const  STONE_SIZE_SMALL_COEF = 0;
const  STONE_SIZE_MEDIUM_COEF = -1.60120203818314;
const  STONE_SIZE_BIG_COEF = -2.23896593985716;

const  STONE_POSITION_LOWER_COEF = 0;
const  STONE_POSITION_MIDDLE_COEF = -0.520079890676012;
const  STONE_POSITION_UPPER_COEF = -1.19137190678227;
